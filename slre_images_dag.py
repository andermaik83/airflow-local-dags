...
dag = DAG(
    ...
    catchup=False,
    tags=['test', 'slre', 'dataproc', 'images'],
)
...
with TaskGroup(group_id='tbSLRE_images', dag=dag) as images_taskgroup:
    ...
    slre_renimg = SSHOperator(
        ...
        command='/TEST/LIB/SLRE/SLRE_renimg/proc/SLRE_renimg.sh ',
        dag=dag,
        doc_md="""
    ...
    slre_grpimgs = SSHOperator(
        ...
        ssh_conn_id=SSH_CONN_ID_1,
        command='/TEST/LIB/SLRE/SLRE_grpimgs/proc/SLRE_startgrpimgs.sh ',
        dag=dag,
        doc_md="""
    ...
    slre_cnvimg = SSHOperator(
        ...
        ssh_conn_id=SSH_CONN_ID_1,
        command='/TEST/LIB/SLRE/SLRE_cnvimg/proc/SLRE_cnvimg.sh ',
        dag=dag,
        doc_md="""
    ...
    slre_ldimg = SSHOperator(
        ...
        ssh_conn_id=SSH_CONN_ID_1,
        command='/TEST/LIB/SLRE/SLRE_cnvldimg/proc/SLRE_cnvldimg.sh ',
        dag=dag,
        doc_md="""
...
slre_cleanup_shrdir = SSHOperator(
    ...
    ssh_conn_id=SSH_CONN_ID_1,
    command='/TEST/LIB/SLRE/SLRE_oper/proc/SLRE_cleanup_SHRDIR.sh 490',
    dag=dag,
    doc_md="""
